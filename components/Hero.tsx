  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="w-full bg-black text-white px-[5%] md:px-[10%] xl:px-[15%] py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
        {/* Row 1 */}
        <div className="flex flex-col justify-center border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="text-[#6BBF00] font-bold text-xl mb-1 group-hover:text-white transition-colors">Efficiency</span>
        ...
        <div className="flex flex-col justify-center border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="text-[#6BBF00] font-bold text-xl mb-1 group-hover:text-white transition-colors">Durability</span>
        ...
        <div className="flex flex-col justify-center border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="text-[#6BBF00] font-bold text-xl mb-1 group-hover:text-white transition-colors">Savings</span>
        ...
        <div className="flex flex-col justify-center border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="text-[#6BBF00] font-bold text-xl mb-1 group-hover:text-white transition-colors">Eco-Friendly</span>
        ...
        {/* Row 2 */}
        <div className="flex flex-col justify-center items-start border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="bg-white/20 text-white text-[10px] px-2 py-0.5 mb-2 uppercase tracking-wider group-hover:bg-[#6BBF00] transition-colors">New</span>
          <span className="text-white text-lg font-medium mb-1 group-hover:text-[#6BBF00] transition-colors">Smart Home Ready</span>
          <span className="text-gray-400 text-xs group-hover:text-gray-300">Connects to app</span>
        </div>
        <div className="flex flex-col justify-center items-start border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="bg-white/20 text-white text-[10px] px-2 py-0.5 mb-2 uppercase tracking-wider group-hover:bg-[#6BBF00] transition-colors">Top</span>
          <span className="text-white text-lg font-medium mb-1 group-hover:text-[#6BBF00] transition-colors">Award Winning</span>
          <span className="text-gray-400 text-xs group-hover:text-gray-300">Best in class 2024</span>
        </div>
        <div className="flex flex-col justify-center items-start border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="bg-white/20 text-white text-[10px] px-2 py-0.5 mb-2 uppercase tracking-wider group-hover:bg-[#6BBF00] transition-colors">Fast</span>
          <span className="text-white text-lg font-medium mb-1 group-hover:text-[#6BBF00] transition-colors">Quick Install</span>
          <span className="text-gray-400 text-xs group-hover:text-gray-300">Setup in 24 hours</span>
        </div>
        <div className="flex flex-col justify-center items-start border border-white/20 p-4 hover:bg-white/10 transition-all duration-300 transform hover:-translate-y-1 hover:border-[#6BBF00]/50 cursor-default group">
          <span className="bg-white/20 text-white text-[10px] px-2 py-0.5 mb-2 uppercase tracking-wider group-hover:bg-[#6BBF00] transition-colors">Safe</span>
          <span className="text-white text-lg font-medium mb-1 group-hover:text-[#6BBF00] transition-colors">Fire Proof</span>
